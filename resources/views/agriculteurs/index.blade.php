    ...
    <div class="px-4 py-6 sm:px-0">
      <div class="border-4 border-dashed  border-gray-200 rounded-lg h-96 overflow-x-auto">
        ...
        <table class="min-w-full text-center">
          ...
          <tbody>
            @foreach ($agriculteurs as $key => $agriculteur)
            <tr class="bg-white border-b">
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ ++$key }}</td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{ $agriculteur->nom }}</td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{ $agriculteur->sexe }}</td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{ $agriculteur->age }} ans</td>
              ...
              <td class="text-center">
                ...
                <button onclick='editAgriculteur(@json($agriculteur))'>
